...
for (i in unique(cluster_ids)){
  ...
  if (length(useonly) >= min_segment){
    ...
    log_coefficients = round(summary(logreg_solution)$coefficients,1)
    Log_Drivers_segment = log_coefficients[,"z value", drop=F]
...
- Segment specific analysis must be considered when data are heterogeneous
