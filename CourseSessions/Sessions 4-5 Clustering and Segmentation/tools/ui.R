...
shinyUI(pageWithSidebar(
  ...
  headerPanel("Cluster Analysis Web App"),
  ...
  sidebarPanel(
    ...
    textInput("segmentation_attributes_used","Enter the segmentation attributes to use (consecutive e.g 1:5 or separate e.g 8,11) separated with comma","1:2,4"),
    textInput("profile_attributes_used","Enter the profiling attributes to use (consecutive e.g 1:5 or separate e.g 8,11) separated with comma","1:2,4"),
    numericInput("numb_clusters_used", "Select Number of clusters to find):", 2),
    selectInput("distance_used", "Select the distance metric to use:", 
