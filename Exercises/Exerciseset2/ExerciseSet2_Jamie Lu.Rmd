...
2. Correlation matrices and principal component getwd (PCA) (see [readings of sessions 3-4](http://inseaddataanalytics.github.io/INSEADAnalytics/Report_s23.html));
...
<br>
<br>
<p> 1. 6 factors explains at least 50% of the variance
</p> 
<p> 2. The highest weights in component 1 are the 5 year and 10 year Treasury Notes
</p>
<p> 3. 
Component 1: Bonds and notes
Compenent 2: Currency
Compenent 3: European Stock Indices
...
Component 10: Asian Stock Indices
</p>
<p> 4.
...
<p>1. The code basically takes the moving average of a specified window size (in this case 20) and if the average return is positive, will buy the future, and if it is negative, will short the future.
</p>

<p>2.  In the code where it says by=#, the # specifies the window size the moving average should be calculated.
</p>
