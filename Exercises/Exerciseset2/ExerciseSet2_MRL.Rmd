...
round(100*sum(StockPrices[,1]),1)
round(100*sum(StockVolume[,1]),1)
round(100*mean(StockReturns[,1]),3)
round(100*sd(StockReturns[,1]),3)
round(100*mean(StockPrices[,1]),3)
round(100*sd(StockPrices[,1]),3)
round(100*mean(StockVolume[,1]),3)
round(100*sd(StockVolume[,1]),3)
